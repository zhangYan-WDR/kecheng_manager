<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="身份证号" prop="studentNo">
        <el-input
...
<!--      </el-col>-->
    ...
    <el-table v-loading="loading" :data="studentList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="身份证号" align="center" prop="studentNo" />
...
<!--          >修改</el-button>-->
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="身份证号" prop="studentNo">
          <el-input v-model="form.studentNo" placeholder="请输入身份证号" />
        </el-form-item>
        <el-form-item label="姓名" prop="studentName">
        ...
        <el-form-item label="年级" prop="studentGrade">
          <el-input v-model="form.studentGrade" placeholder="请输入年级" />
        </el-form-item>
      </el-form>
