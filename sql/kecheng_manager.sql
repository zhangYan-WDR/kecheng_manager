...
-- Records of sys_menu
-- ----------------------------
INSERT INTO `sys_menu` VALUES (1, '系统管理', 0, 1, 'system', NULL, '', 1, 0, 'M', '0', '0', '', 'system', 'admin', '2023-04-23 10:12:39', '', NULL, '系统管理目录');
INSERT INTO `sys_menu` VALUES (2, '系统监控', 0, 2, 'monitor', NULL, '', 1, 0, 'M', '0', '0', '', 'monitor', 'admin', '2023-04-23 10:12:39', '', NULL, '系统监控目录');
INSERT INTO `sys_menu` VALUES (3, '系统工具', 0, 3, 'tool', NULL, '', 1, 0, 'M', '0', '0', '', 'tool', 'admin', '2023-04-23 10:12:39', '', NULL, '系统工具目录');
INSERT INTO `sys_menu` VALUES (4, '若依官网', 0, 4, 'http://ruoyi.vip', NULL, '', 0, 0, 'M', '0', '0', '', 'guide', 'admin', '2023-04-23 10:12:39', '', NULL, '若依官网地址');
INSERT INTO `sys_menu` VALUES (100, '用户管理', 1, 1, 'user', 'system/user/index', '', 1, 0, 'C', '0', '0', 'system:user:list', 'user', 'admin', '2023-04-23 10:12:39', '', NULL, '用户管理菜单');
INSERT INTO `sys_menu` VALUES (101, '角色管理', 1, 2, 'role', 'system/role/index', '', 1, 0, 'C', '0', '0', 'system:role:list', 'peoples', 'admin', '2023-04-23 10:12:39', '', NULL, '角色管理菜单');
INSERT INTO `sys_menu` VALUES (102, '菜单管理', 1, 3, 'menu', 'system/menu/index', '', 1, 0, 'C', '0', '0', 'system:menu:list', 'tree-table', 'admin', '2023-04-23 10:12:39', '', NULL, '菜单管理菜单');
...
INSERT INTO `sys_menu` VALUES (107, '通知公告', 1, 8, 'notice', 'system/notice/index', '', 1, 0, 'C', '0', '0', 'system:notice:list', 'message', 'admin', '2023-04-23 10:12:39', '', NULL, '通知公告菜单');
INSERT INTO `sys_menu` VALUES (108, '日志管理', 1, 9, 'log', '', '', 1, 0, 'M', '0', '0', '', 'log', 'admin', '2023-04-23 10:12:39', '', NULL, '日志管理菜单');
INSERT INTO `sys_menu` VALUES (109, '在线用户', 2, 1, 'online', 'monitor/online/index', '', 1, 0, 'C', '0', '0', 'monitor:online:list', 'online', 'admin', '2023-04-23 10:12:39', '', NULL, '在线用户菜单');
...
INSERT INTO `sys_menu` VALUES (112, '服务监控', 2, 4, 'server', 'monitor/server/index', '', 1, 0, 'C', '0', '0', 'monitor:server:list', 'server', 'admin', '2023-04-23 10:12:39', '', NULL, '服务监控菜单');
...
INSERT INTO `sys_menu` VALUES (2003, '资源库管理', 0, 6, 'bank', 'system/bank/index', NULL, 1, 0, 'C', '0', '0', 'system:bank:list', 'guide', 'admin', '2023-04-24 13:15:49', '', NULL, '');
...
INSERT INTO `sys_role` VALUES (100, '学生', 'student', 3, '1', 1, 1, '0', '0', 'admin', '2023-04-24 10:07:51', 'admin', '2023-04-24 10:33:11', NULL);
INSERT INTO `sys_role` VALUES (101, '教师', 'teacher', 4, '1', 1, 1, '0', '0', 'admin', '2023-04-24 10:08:07', 'admin', '2023-04-24 10:33:17', NULL);
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 103, 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2023-04-24 13:11:15', 'admin', '2023-04-23 10:12:38', '', '2023-04-24 13:11:15', '管理员');
...
INSERT INTO `sys_user` VALUES (100, NULL, '李四', '413026199808121111', '00', '16602132123@163.com', '18072811111', '1', '', '$2a$10$s3G.BKAi4tgyUd17zF5sXuGOAYSMl5LuCLhPsfS7KOAaeWxITu0vK', '0', '0', '127.0.0.1', '2023-04-24 10:33:58', '', '2023-04-24 10:21:21', '', '2023-04-24 10:33:58', NULL);
...
INSERT INTO `sys_user` VALUES (105, NULL, '辣目洋子', '413026199808322431', '00', '43231324223@163.com', '18072813212', '1', '', '$2a$10$DQmbTQkZKCdBUzmK/5SubuEuCaBmgpWKXxC6fgIBWQm8.7/sMSle.', '0', '0', '127.0.0.1', '2023-04-24 10:34:22', '', '2023-04-24 10:33:27', '', '2023-04-24 10:34:22', NULL);
...
CREATE TABLE `td_course`  (
                              ...
                              `course_quality` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '课程性质',
                              `inspect_modality` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '考察形式',
                              `practical_hours` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '实践学时',
                              `open_term` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '开设学期',
                              `credit` int NULL DEFAULT NULL COMMENT '学分',
                              `theoretical_hours` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '理论学时',
...
CREATE TABLE `td_courseware_bank`  (
                                       ...
                                       `section` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '章节',
                                       `courseware_no` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '课件编号',
                                       `view_count` int NULL DEFAULT NULL COMMENT '浏览次数',
                                       `download_count` int NULL DEFAULT NULL COMMENT '下载次数',
                                       `upload_author` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '上传作者',
                                       `file_size` double NULL DEFAULT NULL COMMENT '文件大小',
                                       `course_no` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '课程编号',
                                       `file` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '文件',
                                       `is_checked` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '是否审核',
                                       `upload_time` datetime NULL DEFAULT NULL COMMENT '上传时间',
                                       `type` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '资源类型',
                                       PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `td_courseware_bank` VALUES (1, '1', '1', '1', 1, 1, '1', 1, '1', '/profile/upload/2023/04/24/新建 文本文档_20230424131920A001.txt', '1', '2023-04-24 00:00:00', NULL);
...
CREATE TABLE `td_student`  (
                               ...
                               `student_no` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '身份证号',
                               `student_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '姓名',
                               `student_phone` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '电话',
                               `student_email` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '邮箱',
                               `student_grade` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '年级',
                               `student_password` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '密码',
                               PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `td_teacher`  (
                               ...
                               `teacher_no` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '身份证号',
                               `teacher_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '姓名',
                               `teacher_phone` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '电话',
                               `teacher_email` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '邮箱',
                               `teacher_sex` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '性别',
                               `teacher_password` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '密码',
                               PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
