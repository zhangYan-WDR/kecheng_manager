<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="身份证号" prop="teacherNo">
        <el-input
...
<!--      <el-table-column label="主键" align="center" prop="id" />-->
      <el-table-column label="身份证号" align="center" prop="teacherNo" />
      <el-table-column label="姓名" align="center" prop="teacherName" />
      <el-table-column label="电话" align="center" prop="teacherPhone" />
      <el-table-column label="邮箱" align="center" prop="teacherEmail" />
...
<!--          >修改</el-button>-->
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="身份证号" prop="teacherNo">
          <el-input v-model="form.teacherNo" placeholder="请输入身份证号" />
        </el-form-item>
        <el-form-item label="姓名" prop="teacherName">
          <el-input v-model="form.teacherName" placeholder="请输入姓名" />
        </el-form-item>
        <el-form-item label="电话" prop="teacherPhone">
          <el-input v-model="form.teacherPhone" placeholder="请输入电话" />
        </el-form-item>
        <el-form-item label="邮箱" prop="teacherEmail">
          <el-input v-model="form.teacherEmail" placeholder="请输入邮箱" />
        </el-form-item>
        <el-form-item label="密码" prop="teacherPassword">
          <el-input v-model="form.teacherPassword" placeholder="请输入密码" />
        </el-form-item>
      </el-form>
