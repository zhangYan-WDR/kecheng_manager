<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="courseList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="考察形式" align="center" prop="inspectModality" />
      <el-table-column label="实践学时" align="center" prop="practicalHours" />
      <el-table-column label="开设学期" align="center" prop="openTerm" />
      <el-table-column label="学分" align="center" prop="credit" />
      <el-table-column label="理论学时" align="center" prop="theoreticalHours" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="课程性质" prop="courseQuality">
          <el-input v-model="form.courseQuality" placeholder="请输入课程性质" />
        </el-form-item>
        <el-form-item label="考察形式" prop="inspectModality">
          <el-input v-model="form.inspectModality" placeholder="请输入考察形式" />
        </el-form-item>
        <el-form-item label="实践学时" prop="practicalHours">
          <el-input v-model="form.practicalHours" placeholder="请输入实践学时" />
        </el-form-item>
        <el-form-item label="开设学期" prop="openTerm">
          <el-input v-model="form.openTerm" placeholder="请输入开设学期" />
        </el-form-item>
        <el-form-item label="学分" prop="credit">
          <el-input v-model="form.credit" placeholder="请输入学分" />
        </el-form-item>
        <el-form-item label="理论学时" prop="theoreticalHours">
          <el-input v-model="form.theoreticalHours" placeholder="请输入理论学时" />
        </el-form-item>
      </el-form>
